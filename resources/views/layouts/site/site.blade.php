            ...
            <header class="header">
                <Div class="menu">
                    <div class="h">
                        ...
                        <div class="input"> 
                            <form name="pesquisa" method="GET" action="{{route('produtos')}}" >
                                @csrf
                        ...
                        <div class="usuario"> 
                            <div class="user">
                                ...
                                <div class="us">@if (empty(Auth::user()->name))
                                    ...
                                    @else
                                    <a href="{{route('perfil')}}"><span class="nome-user">{{Auth::user()->name}}</span> <input type="hidden" id="id_user" value="{{Auth::user()->id}}" name="id_user"></a>
                                    <span>
